const info = {
    ...
    socials: {
        twitter: "https://x.com/shivagangam22",
		github: "https://github.com/mcmshivaganga",
		linkedin: "https://www.linkedin.com/in/shivagangaM",
    ...
    projects: [
        {
			...
			description: "A facial recognition system that automates attendance tracking using deep learning and OpenCV. The model identifies individuals in real-time for secure and efficient attendance management.",
			technologies: "https://skillicons.dev/icons?i=react,opencv,flask,tensorflow&perline=5&theme=",
			github: "https://github.com/mcmshivaganag/Secure-Access",
            // link: "https://letterdigitshape-classification.netlify.app/"
		},

		{
			title: "Real-Time Object Detection using YOLO and DeepSORT",
			description: "An advanced real-time object detection and tracking system that identifies and follows multiple objects in video streams using YOLO and DeepSORT algorithms. Designed for applications requiring live monitoring and analysis.",
			technologies: "https://skillicons.dev/icons?i=react,firebase,0,0,0&perline=10&theme=",
			github: "https://github.com/mcmshivaganga/Landlink",
		...
		// 	github: "https://github.com/shivagangamcm/Weaver-s-Loom",
    ...
    contact: {
        ...
        description: "Thank you for your interest in connecting with me. I welcome your feedback, questions, and suggestions. If you have a specific inquiry or comment, please feel free to email me directly at shivagangamcm@gmail.com. I strive to respond to all messages within 24 hours, but please allow a bit more time during busy periods. Alternatively, if you prefer to connect on social media, you can find me using the links provided below.",
    },
